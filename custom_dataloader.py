...
class DataGenerator(Sequence):
    ...
    def on_epoch_end(self):
        ...
        loadthis = self.fileids
        #loadthis = [random.choice(self.fileids)] #Loads a randomly selected file for training.
        ...
        for i in range(0, im.shape[0]):
            im_list += [fileIO.gen_patch(im[i], stride=(256, 256))]
            labels_list += [fileIO.gen_patch(
                labels[i], stride=(256, 256))]
