function [counts,diffcount] = analysis_cellcount_v3()
...
seg_dir = '/home/rohan/Desktop/newtests2/';
...
trainind = 1:numel(train_fileid);
valind = numel(train_fileid)+1:numel(train_fileid)+numel(val_fileid);
...
plot(counts(trainind,1),counts(trainind,2),'o','MarkerSize',5,'MarkerFaceColor',[0 0.3 1],'MarkerEdgeColor',[0.7 0.7 0.7]);axis equal;
plot(counts(valind,1),counts(valind,2),'o','MarkerSize',5,'MarkerFaceColor',[1 0 0],'MarkerEdgeColor',[0.7 0.7 0.7]);axis equal;
